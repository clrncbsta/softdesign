...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-container">
    <h3 class="w3-padding-64"><b>Thirtea Ann<br>User Dashboard</b></h3>
  </div>
  <div class="w3-bar-block">
    <a href="#" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Home</a> 
    <a href="#showcase" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Order</a> 
    <a href="#services" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Services</a> 
    <a href="#designers" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Get Invoice</a> 
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <h1 class="w3-jumbo"><b>Welcome, User!</b></h1>
    <h1 class="w3-xxxlarge w3-text-red"><b>One Sip, One Cup.</b></h1>
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-red"><b>Order</b></h1>
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <p>This is where the order section will be</p>
  ...
  <div class="w3-container" id="designers" style="margin-top:75px">
    ...
    <hr style="width:50px;border:5px solid red" class="w3-round">
    <p>Services section, but may change upon future development</p>
    ...
    <p><b>Our leaders are thoughtfully chosen</b>:</p>
  </div>
  ...
  <div class="w3-row-padding w3-grayscale">
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="/w3images/team2.jpg" alt="annkhresna" style="width:100%">
        <div class="w3-container">
          <h3>Ann Khresna Red-Serrano</h3>
    ...
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="/w3images/team1.jpg" alt="annheyzelin" style="width:100%">
        <div class="w3-container">
          <h3>Ann Heyzelin Red-Libiano</h3>
          <p class="w3-opacity">COO & Founder</p>
          <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
        </div>
      </div>
    </div>
    <div class="w3-col m4 w3-margin-bottom">
      <div class="w3-light-grey">
        <img src="/w3images/team3.jpg" alt="anndarylei" style="width:100%">
        <div class="w3-container">
          <h3>Ann Darylei Red-Dela Cruz</h3>
          <p class="w3-opacity">Manager & Head Supervisor</p>
          <p>Phasellus eget enim eu lectus faucibus vestibulum. Suspendisse sodales pellentesque elementum.</p>
        </div>
      </div>
    </div>
